...
class StockMove(models.Model):
    ...
    snap_stock = fields.Float(string="Snap stock")
...
class StockPicking(models.Model):
    ...
    def button_validate(self):
        ...
        for line in self.move_ids_without_package:
            print(line.product_id.product_tmpl_id.qty_available)
            line.snap_stock = line.product_id.product_tmpl_id.qty_available
