    ...
    def create_lab_test(self):
        ...
        for browse_record in browse_records:
            ...
            if res_ids:
                ...
                action = imd.xmlid_to_object('hospitalmanagment.action_medical_lab_tree')
                list_view_id = imd.xmlid_to_res_id('hospitalmanagment.medical_lab_tree_view')
                form_view_id  =  imd.xmlid_to_res_id('hospitalmanagment.medical_lab_form_view')
                result = {
                                'name': action.name,
                                'help': action.help,
                                'type': action.type,
