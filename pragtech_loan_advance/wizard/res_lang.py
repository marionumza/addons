...
class ResLang(models.Model):
    ...
    "Modified by Pragmatic to get Date instead of datetime"
    @api.model
    def date_formatter(self, value, lang=None, template=MODE_DATETIME,
...
#                                 DEFAULT_SERVER_TIME_FORMAT)
        ...
        if isinstance(value, str):
            try:
                ...
                print("DDDDDDDDDDDDDDDDDDD",value,type(value))
            except ValueError:
        ...
        print("\n\n\n\nvalue.strftime(template)============",value.strftime(template),type(value.strftime(template)))
