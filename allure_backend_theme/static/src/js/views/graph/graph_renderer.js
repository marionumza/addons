odoo.define('allure_backend_theme.GraphRenderer', function (require) {
    "use strict";
    ...
    return GraphRenderer.include({
        ...
        _fetchThemeColors: function () {
            ...
            return self._rpc({
                ...
                method: 'get_param',
                args: ['allure_backend_theme.selected_theme']
        ...
        _render: function () {
            ...
            if (!_.contains(CHART_TYPES, this.state.mode)) {
                ...
                self._rpc({
                    ...
                    if (results[0].mode === 'night_mode_off'){
                        self._fetchThemeColors().then(function () {
                            self._renderGraph();
                        });
                    }
                    else{
                        self.theme_colors.push("#128193", "#78a0ff", "#00b3e5", "#ca0c05", "#00aa00", "#e47e01", "#005ba9", "#717171")
                        self._renderGraph();
                    }
                });
            }
